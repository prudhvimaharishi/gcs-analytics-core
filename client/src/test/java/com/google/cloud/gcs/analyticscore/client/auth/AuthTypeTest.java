...
class AuthTypeTest {
  ...
  @CsvSource({
    ...
    "WORKLOAD_IDENTITY_FEDERATION_CREDENTIAL_CONFIG_FILE, WORKLOAD_IDENTITY_FEDERATION_CREDENTIAL_CONFIG_FILE",
    "workload-identity-federation-credential-config-file, WORKLOAD_IDENTITY_FEDERATION_CREDENTIAL_CONFIG_FILE",
