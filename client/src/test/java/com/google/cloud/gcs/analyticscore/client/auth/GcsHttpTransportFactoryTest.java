...
class GcsHttpTransportFactoryTest {
  ...
  void createNetHttpTransportBuilder_installsCustomSslSocketFactory()
    ...
    NetHttpTransport.Builder builder =
        GcsHttpTransportFactory.createNetHttpTransportBuilder(null, Duration.ofSeconds(5), false);
  ...
  void createNetHttpTransportBuilder_systemDefaultTrustStore_usesSystemDefaultSocketFactory()
      throws IOException, GeneralSecurityException {
    NetHttpTransport.Builder builder =
        GcsHttpTransportFactory.createNetHttpTransportBuilder(null, Duration.ofSeconds(5), true);
  ...
  void createHttpTransport_noProxy_createsNetHttpTransport() throws IOException {
    HttpTransport transport =
        GcsHttpTransportFactory.createHttpTransport(null, null, null, Duration.ofSeconds(5), false);
  ...
  void createHttpTransport_systemDefaultTrustStore_createsNetHttpTransport() throws IOException {
    HttpTransport transport =
        GcsHttpTransportFactory.createHttpTransport(null, null, null, Duration.ofSeconds(5), true);
  ...
  private static void installProxyAuthenticator() throws IOException {
    GcsHttpTransportFactory.createHttpTransport(
        PROXY_ADDRESS, PROXY_USERNAME, PROXY_PASSWORD, Duration.ofSeconds(10), false);
  }
  ...
  void createHttpTransport_fromGcsAuthOptionsWithProxy_createsNetHttpTransport()
    ...
    HttpTransport transport = GcsHttpTransportFactory.createHttpTransport(options, false);
  ...
  void createHttpTransport_proxyAuthWithoutProxyAddress_throwsIllegalArgumentException() {
    assertThrows(
        ...
        () ->
            GcsHttpTransportFactory.createHttpTransport(
                null, PROXY_USERNAME, PROXY_PASSWORD, null, false));
  }
  ...
  void createHttpTransport_proxyUsernameWithoutPassword_throwsIllegalArgumentException() {
    assertThrows(
        ...
        () ->
            GcsHttpTransportFactory.createHttpTransport(
                "proxy.example.com:8080", PROXY_USERNAME, null, null, false));
  }
  ...
  void createHttpTransport_proxyPasswordWithoutUsername_throwsIllegalArgumentException() {
    assertThrows(
        ...
        () ->
            GcsHttpTransportFactory.createHttpTransport(
                "proxy.example.com:8080", null, PROXY_PASSWORD, null, false));
  }
  ...
  void createHttpTransport_negativeReadTimeout_throwsIllegalArgumentException() {
    assertThrows(
        ...
        () ->
            GcsHttpTransportFactory.createHttpTransport(
                null, null, null, Duration.ofMillis(-1), false));
  }
  ...
  void createHttpTransport_subMillisecondReadTimeout_throwsIllegalArgumentException() {
    ...
    assertThrows(
        ...
        () ->
            GcsHttpTransportFactory.createHttpTransport(
                null, null, null, Duration.ofNanos(500), false));
  }
  ...
  void createNetHttpTransportBuilder_zeroReadTimeout_leavesReadTimeoutUnbounded()
      throws IOException, GeneralSecurityException {
    NetHttpTransport.Builder builder =
        GcsHttpTransportFactory.createNetHttpTransportBuilder(null, Duration.ZERO, false);
  ...
  void createNetHttpTransportBuilder_noReadTimeout_leavesReadTimeoutUnbounded()
      throws IOException, GeneralSecurityException {
    NetHttpTransport.Builder builder =
        GcsHttpTransportFactory.createNetHttpTransportBuilder(null, null, false);
  ...
  void createNetHttpTransportBuilder_readTimeout_appliesTimeoutToSocketFactory()
      throws IOException, GeneralSecurityException {
    NetHttpTransport.Builder builder =
        GcsHttpTransportFactory.createNetHttpTransportBuilder(null, Duration.ofSeconds(7), false);
  ...
  void createHttpTransport_readTimeoutOverflowingInt_throwsIllegalArgumentException() {
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> GcsHttpTransportFactory.createHttpTransport(null, null, null, readTimeout, false));
  }
    ...
    assertThrows(
        ...
        () ->
            GcsHttpTransportFactory.createNetHttpTransport(
                null, new PasswordAuthentication("u", "p".toCharArray()), null, false));
  }
