...
public final class GcsTransportOptionsProvider {
  ...
  private final TrustStoreSource storageTrustStoreSource;
  ...
  public GcsTransportOptionsProvider(
    ...
    this.storageTrustStoreSource =
        usesNonGoogleEndpoint(storageEndpoint, universeDomain)
            ? TrustStoreSource.SYSTEM_DEFAULT
            : TrustStoreSource.GOOGLE_BUNDLED;
    this.authTransport = memoizeTransport(options, TrustStoreSource.GOOGLE_BUNDLED);
    this.storageTransport = memoizeTransport(options, this.storageTrustStoreSource);
  }
  ...
  private static Supplier<HttpTransport> memoizeTransport(
    ...
    return Suppliers.memoize(
        () -> {
          try {
            return GcsHttpTransportFactory.createHttpTransport(options, trustStoreSource);
          } catch (IOException e) {
  ...
  boolean usesSystemDefaultTrustStore() {
    return storageTrustStoreSource.isSystemDefault();
  }
}
