...
final class ParquetLayoutFixtures {
  ...
  static ParquetColumnChunk columnChunk(
      String columnPath, int rowGroupOrdinal, long startOffset, long compressedSize) {
  ...
  static ParquetRowGroup rowGroup(int ordinal, ParquetColumnChunk... columnChunks) {
    ParquetRowGroup.Builder builder = ParquetRowGroup.builder().setOrdinal(ordinal).setRowCount(10);
