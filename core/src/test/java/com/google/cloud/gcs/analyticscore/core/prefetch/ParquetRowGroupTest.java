...
public class ParquetRowGroupTest {
  ...
  void getColumnChunk_knownColumnPath_returnsThatChunk() {
    ParquetColumnChunk price = columnChunk("price", 0, 100, 50);
    ParquetRowGroup group = rowGroup(0, price, columnChunk("name", 0, 150, 30));
  ...
  void getColumnChunk_unknownColumnPath_returnsEmpty() {
    ParquetRowGroup group = rowGroup(0, columnChunk("price", 0, 100, 50));
  ...
  void getStartOffset_returnsLowestChunkStartOffset() {
    ParquetRowGroup group =
        rowGroup(0, columnChunk("price", 0, 300, 50), columnChunk("name", 0, 100, 50));
  ...
  void addColumnChunk_keysTheChunkByItsColumnPath() {
    ParquetRowGroup group = rowGroup(0, columnChunk("address.city", 0, 100, 50));
