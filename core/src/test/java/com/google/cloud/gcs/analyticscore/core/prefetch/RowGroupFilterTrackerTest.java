...
class RowGroupFilterTrackerTest {
  ...
  private static ParquetFileLayout createLayoutWithStatusRanges(String[][] minMaxPairs) {
    ...
    for (int ordinal = 0; ordinal < minMaxPairs.length; ordinal++) {
      ...
      ParquetColumnChunk chunk =
          ParquetColumnChunk.builder()
              ...
              .setDictionaryPageOffset(ordinal * 1000L)
      ...
      rowGroups.add(
          ParquetRowGroup.builder()
              .setOrdinal(ordinal)
              .setRowCount(100L)
              .setColumnChunks(ImmutableMap.of(FILTER_COLUMN, chunk))
              .build());
    }
